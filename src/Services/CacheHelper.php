...
class CacheHelper {
    ...
    public function __construct(CacheInterface $cache, ScrubUrlHelper $scrubUrlHelper, LocationHelper $locationHelper, KernelInterface $kernel, RouterInterface $router)
    {
